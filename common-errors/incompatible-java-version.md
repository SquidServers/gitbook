...
> Still receiving what looks like Java errors? Create a ticket using the #support-ticket channel in [our discord](https://discord.gg/invite/9pvPZqY6RK)
...
> Still having issues? First consult the [fabric documentation](incompatible-java-version.md#official-fabric-docs) below then open a ticket using #support-ticket channel in [our discord](https://discord.gg/invite/9pvPZqY6RK)
